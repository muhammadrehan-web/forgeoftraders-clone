  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          rel="preload"
          href="/templates/template2/fonts/forge-brand-icons.woff2"
          as="font"
          type="font/woff2"
          crossOrigin="anonymous"
        />
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `try{if(sessionStorage.getItem('forge.offer.minimised')==='true')document.documentElement.classList.add('offer-collapsed')}catch{}`,
          }}
        />
        <link
          id="forge-styles"
